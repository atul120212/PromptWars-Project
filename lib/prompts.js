...
export const DOMAIN_EXAMPLES = {
  MEDICAL:
    '"My dad is sweating and not responding, we are near highway 5, he takes metformin"',
  EMERGENCY:
    '"Help! Accident happened at junction of 5th and Main, two cars, someone is trapped"',
  TRAVEL:
    '"Need to reach airport by 3pm, traffic is crazy downtown, it\'s raining"',
  CRISIS:
    '"Multiple reports of flooding in riverside district, power outages, social media conflicting"',
  ENVIRONMENT: '"AQI 287 in my area, my kid has asthma, what do I do"',
  GENERAL:
    "Enter any messy, real-world input and let IntentBridge AI structure it...",
};
